...
typedef enum { TY_unknown, TY_void, TY_bool, TY_int, TY_float } type;

enum global_prefix {
    global_prefix_none = 0,
    global_prefix_extern = 0,
    global_prefix_export = 0,
};

typedef struct { type ty; char *id;} fun_param;

typedef struct { type return_ty; char *id; uint8_t param_count; fun_param *params;} fun_header;
